 ...
 *       - BearerAuth: []
 *     responses:
 *       200: { description: 'Envelope { ok, data } — lista { id, description, idNfce, enable, appMobile, blockForCustomerBlocked, blockForCustomerNoLimit, maxParcels, tef, financialPlansIdCre, financialPlansIdDeb, usagePreference, financialPlanCreDescription, financialPlanDebDescription }' }
